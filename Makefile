#############################################################################
# Makefile for building: tahoon
# Generated by qmake (2.01a) (Qt 4.8.4) on: Mon Feb 18 16:16:43 2013
# Project:  tahoon.pro
# Template: app
# Command: /usr/bin/qmake-qt4 -o Makefile tahoon.pro
#############################################################################
...
Makefile: tahoon.pro  /usr/lib64/qt4/mkspecs/linux-g++/qmake.conf /usr/lib64/qt4/mkspecs/common/unix.conf \
		/usr/lib64/qt4/mkspecs/common/linux.conf \
		/usr/lib64/qt4/mkspecs/common/gcc-base.conf \
		/usr/lib64/qt4/mkspecs/common/gcc-base-unix.conf \
		/usr/lib64/qt4/mkspecs/common/g++-base.conf \
...
dist: 
	@$(CHK_DIR_EXISTS) .tmp/tahoon1.0.0 || $(MKDIR) .tmp/tahoon1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/tahoon1.0.0/ && $(COPY_FILE) --parents new.h .tmp/tahoon1.0.0/ && $(COPY_FILE) --parents new.cpp tahoon.cpp .tmp/tahoon1.0.0/ && (cd `dirname .tmp/tahoon1.0.0` && $(TAR) tahoon1.0.0.tar tahoon1.0.0 && $(COMPRESS) tahoon1.0.0.tar) && $(MOVE) `dirname .tmp/tahoon1.0.0`/tahoon1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/tahoon1.0.0
...
compiler_moc_header_make_all: moc_new.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_new.cpp
moc_new.cpp: new.h
	/usr/lib64/qt4/bin/moc $(DEFINES) $(INCPATH) new.h -o moc_new.cpp
...
new.o: new.cpp new.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o new.o new.cpp

tahoon.o: tahoon.cpp new.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o tahoon.o tahoon.cpp

moc_new.o: moc_new.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_new.o moc_new.cpp
